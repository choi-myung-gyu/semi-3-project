...
<body>
    <div class="container">
		...
		<table>
			<tr>
				<td>아이디</td>
				<td><input type="text" name="id" maxlength="20" placeholder="영문 최대 20자 까지 가능" ></td>
			</tr>
			<tr>
				<td>비밀번호</td>
				<td><input type="password" name="pass1" maxlength="20" placeholder="영문 최대 20자 까지 가능" ></td>
			</tr>
			<tr>
				<td>비밀번호 확인</td>
			...
			<tr>
				<td>핸드폰번호</td>
				<td><input type="text" name="phone" maxlength="20"  placeholder="(-) 입력해주세요" required></td>
			</tr>
			<tr>
